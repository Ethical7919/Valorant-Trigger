...
key_hold	:=	"Alt" 	; key that you hold to scan (example "T") 	
...
tap_time	:=	99		; Delay in ms between shots when triggered
...
Gui,2:Add,Text, xp yp wp hp cwhite BackgroundTrans Center 0x200 vB3 gStart,STATUS : ON
...
Gui,2:Add,Text, xp yp wp hp cwhite BackgroundTrans Center 0x200 vB1 gStart,STATUS : OFF
